...
export class AppComponent {
  ...
  createMovie()
  {
    ...
    "The X-Men must unite to defeat extinction-level plan",
    49, this.repo.movies[0].studio));
  }
  ...
  replaceMovie()
  {
    ...
    m.name = "Triple Modified Movie";
    m.category = "Triple Modified Category";
  ...
  updateMovie()
  {
    ...
    this.repo.updateMovie(2, changes);
  }
  deleteMovie()
  {
    this.repo.deleteMovie(3);
  }
  deleteStudio()
  {
    this.repo.deleteStudio(1);
  }
}
