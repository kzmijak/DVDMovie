...
namespace DVDMovie.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        public MovieController(DataContext ctx) => (context) = (ctx);
    	...
    	public Movie GetMovie(long id)
    	{
            Movie result = context.Movies
                    ...
                    .Include(m => m.Ratings).ThenInclude(r => r.Movie)
        ...
        public IEnumerable<Movie> GetMovies(string category, string search, bool related = false)
        {
            ...
            if(!string.IsNullOrWhiteSpace(search))
            {
                ...
                query = query.Where(m => m.Name.ToLower().Contains(searchLower) || m.Description.ToLower().Contains(searchLower));
            }
            if(related)
            {
